...
Add-BuildTask DeployPSGallery {
    ...
    try {
        Register-PSRepository -Name 'hjorslev' -SourceLocation 'https://ci.appveyor.com/nuget/hjorslev/' -PublishLocation 'https://ci.appveyor.com/nuget/hjorslev/api/v2/package'
